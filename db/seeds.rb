...
Instrument.create!([{
  ...
  finish: "Red",
  price: "3",
  image: Rails.root.join("app/assets/images/instrument1.jpeg").open,
  user_id: user.id
},
{
...
The nitro-cellulose lacquer finish and our proprietary antiquing process make each Classic Antique™ feel like it has been loved for years. The Classic Antique now includes: our innovative SSCII (Silent Single-Coil) hum cancelling system, a vintage tinted nitrocellulose neck with stainless steel frets, and a Maple fingerboard option.",
  ...
  finish: "Seafoam",
  price: "5",
  image: Rails.root.join("app/assets/images/instrument3.jpeg").open,
  user_id: user.id
},
{
  ...
  finish: "Clear",
  price: "6",
  image: Rails.root.join("app/assets/images/instrument4.jpeg").open,
  user_id: user.id
},
{
  ...
  finish: "Red",
  price: "599",
  image: Rails.root.join("app/assets/images/instrument5.jpeg").open,
  user_id: user.id
},
{
  ...
  finish: "Yellow",
  price: "7",
  image: Rails.root.join("app/assets/images/instrument6.jpeg").open,
  user_id: user.id
}])
